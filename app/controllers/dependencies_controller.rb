class DependenciesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @dependency.save
        format.html { redirect_to @dependency, notice: 'Dependencia creada con exito.' }
  ...
  def update
    respond_to do |format|
      if @dependency.update(dependency_params)
        format.html { redirect_to @dependency, notice: 'Datos actualizados con exito.' }
  ...
  def destroy
    @dependency.destroy
    respond_to do |format|
      format.html { redirect_to dependencies_url, notice: 'Se ha eliminado correctamente.' }

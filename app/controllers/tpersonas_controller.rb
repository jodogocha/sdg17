class TpersonasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tpersona.save
        format.html { redirect_to @tpersona, notice: 'Tipo de Persona agregada con exito.' }
  ...
  def update
    respond_to do |format|
      if @tpersona.update(tpersona_params)
        format.html { redirect_to @tpersona, notice: 'Datos actualizados con exito.' }
  ...
  def destroy
    @tpersona.destroy
    respond_to do |format|
      format.html { redirect_to tpersonas_url, notice: 'Se ha eliminado correctamente.' }
